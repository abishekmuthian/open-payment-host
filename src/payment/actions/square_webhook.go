...
func HandleSquareWebhook(w http.ResponseWriter, r *http.Request) error {
	...
	var eventSubscription payment.EventSubscriptionModel
	...
	subscription, err = subscriptions.FindSubscription(eventSubscription.Data.Object.Subscription.ID)
	if err != nil {
...
func recordSquareSubscriptionPaymentTransaction(eventSubscription payment.EventSubscriptionModel, subscription *subscriptions.Subscription) error {
